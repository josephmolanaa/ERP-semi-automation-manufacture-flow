...
class RolePermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $permissions = [
            ...
            // PO
            'view_po', 'create_po', 'edit_po', 'delete_po',
            // Job Order
            'view_job_order', 'create_job_order', 'edit_job_order',
            'delete_job_order', 'update_job_progress',
            // Surat Jalan
            'view_surat_jalan', 'create_surat_jalan', 'edit_surat_jalan',
            'delete_surat_jalan',
            // Invoice
            'view_invoice', 'create_invoice', 'edit_invoice',
            'delete_invoice', 'mark_paid_invoice',
            // Dashboard
            'view_dashboard',
        ];
        ...
        Role::findByName('sales')->givePermissionTo([
            'view_quotation', 'create_quotation', 'edit_quotation',
            'send_quotation', 'convert_quotation', 'view_po', 'view_dashboard',
        ]);

        // Produksi
        Role::findByName('produksi')->givePermissionTo([
            'view_job_order', 'create_job_order', 'edit_job_order',
            'update_job_progress', 'view_dashboard',
        ]);

        // Finance
        Role::findByName('finance')->givePermissionTo([
            'view_invoice', 'create_invoice', 'edit_invoice', 'mark_paid_invoice',
